...
@section('header')
    <div class="flex items-center gap-4">
        <span class="text-slate-500 dark:text-slate-400 font-normal">Edit Category:</span>
            ...
            <div class="overflow-hidden rounded-2xl bg-white dark:bg-dark-card shadow-sm ring-1 ring-slate-200 dark:ring-dark-border">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="border-b border-slate-100 dark:border-dark-border pb-5 mb-5">
                        ...
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Update the category information.</p>
                    </div>
                                ...
                                >
                                    ...
                                    @foreach ($classifications as $classification)
                                        <option 
                                            ...
                                            {{ old('classification_id', $category->classification_id) == $classification->id ? 'selected' : '' }}
                                        >
                                            {{ $classification->name }}
                                        </option>
                                    @endforeach
