...
@section('header')
    <div class="flex items-center gap-4">
        <span class="text-slate-500 dark:text-slate-400 font-normal">Edit Classification:</span>
        <span class="text-slate-900 dark:text-white">{{ $classification->name }}</span>
    </div>
@endsection
            ...
            <div class="overflow-hidden rounded-2xl bg-white dark:bg-dark-card shadow-sm ring-1 ring-slate-200 dark:ring-dark-border">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="border-b border-slate-100 dark:border-dark-border pb-5 mb-5">
                        ...
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Update the information for this classification.</p>
                    </div>
