            ...
            <div class="overflow-hidden rounded-2xl bg-white dark:bg-dark-card shadow-sm ring-1 ring-slate-200 dark:ring-dark-border">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="border-b border-slate-100 dark:border-dark-border pb-5 mb-5">
                        ...
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Define a specific book type or edition format.</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input 
                                    ...
                                    name="name" 
                                    id="name" 
                                    placeholder="e.g. Hardcover, 1st Edition" 
                                    required
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">Select the category this type belongs to.</p>
                        </div>
